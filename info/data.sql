...
-- Demo category level 3.
-- ===========================================
-- 1️⃣ CATEGORY LEVEL 1 (cha gốc)
-- ===========================================
-- id kế tiếp sau 157 => 158
INSERT INTO categories (id, module_id, parent_id, title, description, order_index, is_active)
VALUES (158, 16, NULL, 'AI Feature Management', 'Module to manage AI feature setup and processing flow', 1, TRUE);

-- ===========================================
-- 2️⃣ CATEGORY LEVEL 2 (2 mục con của category 158)
-- ===========================================
-- id 159 - 160
INSERT INTO categories (id, module_id, parent_id, title, description, order_index, is_active) VALUES
(159, 16, 158, 'Model Configuration', 'Manage AI model parameters and setup', 1, TRUE),
(160, 16, 158, 'Model Evaluation', 'Handle evaluation, performance testing, and result tracking', 2, TRUE);

-- ===========================================
-- 3️⃣ CATEGORY LEVEL 3 (5 mục con cho mỗi category lv2)
-- ===========================================
-- Cho Model Configuration (parent_id = 159)
INSERT INTO categories (id, module_id, parent_id, title, description, order_index, is_active) VALUES
(161, 16, 159, 'Parameter Setup', 'Define model hyperparameters', 1, TRUE),
(162, 16, 159, 'Data Preprocessing', 'Setup data normalization, cleaning, and encoding', 2, TRUE),
(163, 16, 159, 'Feature Selection', 'Select key features for model input', 3, TRUE),
(164, 16, 159, 'Model Versioning', 'Maintain different versions of AI models', 4, TRUE),
(165, 16, 159, 'Deployment Settings', 'Setup deployment environment for AI model', 5, TRUE);

-- Cho Model Evaluation (parent_id = 160)
INSERT INTO categories (id, module_id, parent_id, title, description, order_index, is_active) VALUES
(166, 16, 160, 'Evaluation Metrics', 'Define accuracy, recall, precision metrics', 1, TRUE),
(167, 16, 160, 'Test Dataset Management', 'Manage datasets for model validation', 2, TRUE),
(168, 16, 160, 'Result Visualization', 'Display graphs and performance dashboards', 3, TRUE),
(169, 16, 160, 'Model Comparison', 'Compare multiple models and select best performer', 4, TRUE),
(170, 16, 160, 'Continuous Monitoring', 'Track live performance and drift over time', 5, TRUE);
